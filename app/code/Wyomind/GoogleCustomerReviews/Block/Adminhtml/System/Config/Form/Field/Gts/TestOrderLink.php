...
namespace Wyomind\GoogleCustomerReviews\Block\Adminhtml\System\Config\Form\Field\Gts;
...
class TestOrderLink extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $urlTest = $this->_backendHelper->getUrl('googlecustomerreviews/devtools/gtstestorder/', ['website' => $website != null ? $website : -1]);
        $urlValidator = $this->_urlBuilder->getDirectUrl('googlecustomerreviews/devtools/gtstestorder'.($website != null ? '/website/'.$website.'/' : ''));

        $html = "<input type='text' class='input-text' style='width:200px;' placeholder='".__("Order number")."' id='gts-order-number'/>"
