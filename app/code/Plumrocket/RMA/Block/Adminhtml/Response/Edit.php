...
namespace Plumrocket\RMA\Block\Adminhtml\Response;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Plumrocket_RMA::response')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
    ...
    {
        if ($model->getId()) {
            return __("Edit Quick Response Template");
        } else {
            return __('New Quick Response Template');
        }
    }
