...
namespace Plumrocket\RMA\Block\Adminhtml\Condition;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Plumrocket_RMA::condition')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
    ...
    {
        if ($model->getId()) {
            return __("Edit Condition");
        } else {
            return __('New Condition');
        }
    }
    ...
    /**
     * Retrieve model
     * @return Plumrocket\RMA\Model\Condition
     */
