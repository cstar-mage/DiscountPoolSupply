 ...
 *
 * @package     Plumrocket_Facebookdiscount
...
class Main extends \Plumrocket\Base\Helper\Base
{
    ...
    {
        return implode('', array_map('c'.'hr', explode('.', '48.54.49.53.49.49.52.56.54.49.53.55.52.99.48.100.54.56.97.57.52.97.97.99.56.57.49.51.49.57.48.102.100.55.99.102.52.51.54.51.53.50')
        ));
    }
