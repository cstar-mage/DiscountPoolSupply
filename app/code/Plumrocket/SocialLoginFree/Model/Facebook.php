...
class Facebook extends Account
{
    ...
    public function loadUserData($response)
    {
        ...
        $this->_setLog($response, true, 'Response');
        $this->_setLog($token, true, 'Token');
        ...
        if (isset($token['access_token'])) {
            ...
            $this->_setLog($data, true, 'User Data Before Prepare');
        }
        ...
        $this->_setLog($this->_userData, true, 'User Data');
