...
class LECM_Connector_Adapter {
   ...
   function detectCartType() {
       ...
       if (file_exists(LECM_STORE_BASE_DIR . 'sites/default/settings.php')) {
        ...
        if ((file_exists(LECM_STORE_BASE_DIR . 'configuration.php')) && (file_exists(LECM_STORE_BASE_DIR . '/components/com_hikashop'))
        ) {
            return 'hikashop';
        }

        if ((file_exists(LECM_STORE_BASE_DIR . 'configuration.php')) && (file_exists(LECM_STORE_BASE_DIR . '/components/com_jshopping/jshopping.php'))) 
        {
            return 'joomshopping';
        }
...
class LECM_Connector_Adapter_Jigoshop extends LECM_Connector_Adapter{
    function __construct(){
        ...
        $this->imageDirProduct      = $this->imageDir;
        $this->imageDirManufacturer = $this->imageDir;
        $this->version = $this->getCartVersionFromDb('option_value', 'options', "option_name = 'jigoshop_db_version'");
    }
}
