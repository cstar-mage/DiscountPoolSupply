...
class LECM_Connector_Adapter {
    ...
    function detectCartType() {
        ...
        //LDV94begin
        if (file_exists(LECM_STORE_BASE_DIR . 'app' . DIRECTORY_SEPARATOR . 'etc' . DIRECTORY_SEPARATOR . 'config.php') && file_exists(LECM_STORE_BASE_DIR . 'app' . DIRECTORY_SEPARATOR . 'etc' . DIRECTORY_SEPARATOR . 'di.xml') && file_exists(LECM_STORE_BASE_DIR . 'app' . DIRECTORY_SEPARATOR . 'etc' . DIRECTORY_SEPARATOR . 'env.php')) {
            return 'magento';
        }
        //LDV94end
        // Interspire
...
class LECM_Connector_Adapter_Magento extends LECM_Connector_Adapter {
    ...
    function setEnv() {
        ...
        $this->setHostPort('discountnew.cepl6na8nshq.ca-central-1.rds.amazonaws.com');
        $this->username = 'dpoolsup';
        $this->password = 'JLQ5rPctt5rNV6bN';
        $this->database = 'dpsmagento';
        $this->tablePrefix = '';
